...
# Path to the image file to select points from
image_file = 'handmer-electrolyzer.jpg'  # Change as needed
...
x_min = 48   # e.g., corresponds to pixel x = 0
x_max = 75  # e.g., corresponds to pixel x = max_x
y_min = 0     # e.g., corresponds to pixel y = 0
y_max = 2000    # e.g., corresponds to pixel y = max_y
